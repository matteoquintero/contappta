...
var f=d(e).then(function(h){return h.data[0];});return f;}};return c;}).factory("sons",function(d){var b=JSON.parse(window.localStorage.user||"{}");var a=b.idUsuario;
var c={all:function(){var e={method:"POST",url:"http://localhost/contappta/dashboard/application/controller/app/sons.php",headers:{"Content-Type":" application/json "},params:{user:a}};
var f=d(e).then(function(g){return g.data;});return f;}};return c;}).factory("users",function(b){var a={get:function(e){var c={method:"POST",url:"http://localhost/contappta/dashboard/application/controller/app/users.php",headers:{"Content-Type":" application/json "},params:{user:e}};
