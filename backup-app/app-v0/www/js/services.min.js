...
var h=d.promise;var g={method:"POST",url:b.controller+"login.php",headers:{"Content-Type":" application/json "},params:{user:e,password:f,devicetoken:localStorage.getItem("devicetoken"),idonesignal:localStorage.getItem("idonesignal")}};
c(g).then(function(j){if(j.data[0]===true){localStorage.setItem("user",JSON.stringify(j.data[1]));localStorage.setItem("institution",JSON.stringify(j.data[2]));
