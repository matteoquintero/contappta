...
! function(e, t) {
    ...
    function n(t, n, a, i, r, o) {
        ...
        if (angular.isDefined(i) && angular.isArray(i))
            for (var u = 0; u < i.length; u++)
                if (s = new Date(i[u].getFullYear(), i[u].getMonth(), i[u].getDate()), e(s, d)) return !0;
        return !1
    }
    ...
    var r = {},
        ...
        d = function(e, t) {
            for (var n = 0, a = [], i = [], r = e; t >= r; r++) i.push(r), n++, n % 12 === 0 && (a.push({
                years: i
            }), i = []);
        ...
        h = function(e) {
            for (var n = !1, a = 0, r = [], o = t(e.date, e.mondayFirst), d = o.getMonth(); !n;) r.push({
                days: i(o, e.date, e.disablePastDays, e.disableWeekend, e.disableDates, e.displayFrom, e.displayTo, e.highlights)
            }), o.setDate(o.getDate() + 7), n = a++ > 1 && d !== o.getMonth(), d = o.getMonth();
            return r
        },
        g = function(e) {
            var t = new Date;
