...
.controller('DashCtrl', function($scope, news,perfil) {
  ...
  news.all().then(function(response) { console.log(response); $scope.notices=response; });
    $scope.doRefresh();
...
.controller('DashDetailCtrl', function($scope, $stateParams,$state, news,respuesta,$cordovaFileTransfer) {
