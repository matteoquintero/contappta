<?php
/**
 * Table Definition for eventremindersminute
 */

class DataObject_Eventremindersminute extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'eventremindersminute';            // table name
    public $idNotificacion;                  // int(11)  
    public $idEvento;                        // int(11)  not_null unsigned
    public $fechaInicio;                     // datetime(19)  binary

    /* Static get */
    function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('DataObject_Eventremindersminute',$k,$v); }
