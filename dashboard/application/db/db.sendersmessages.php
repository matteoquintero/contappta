<?php
/**
 * Table Definition for sendersmessages
 */

class DataObject_Sendersmessages extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'sendersmessages';                 // table name
    ...
    /* Static get */
    function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('DataObject_Sendersmessages',$k,$v); }
