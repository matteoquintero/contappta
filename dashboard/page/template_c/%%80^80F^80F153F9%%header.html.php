...
<html>
  <head>
    ...
    <title><?php echo $this->_tpl_vars['datasection']['title']; ?>
</title>
    <!-- Tell the browser to be responsive to screen width -->
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
    <!-- Bootstrap 3.3.5 -->
    <link rel="stylesheet" href="<?php echo ((is_array($_tmp='resources/css/vendor/bootstrap.css')) ? $this->_run_mod_handler('fileversion', true, $_tmp) : fileversion($_tmp)); ?>
">
    <!-- Font Awesome -->
...
">
    <!-- iCheck -->
    <link rel="stylesheet" href="<?php echo ((is_array($_tmp='resources/css/contaapta/skin-black.css')) ? $this->_run_mod_handler('fileversion', true, $_tmp) : fileversion($_tmp)); ?>
">
