<?php /* Smarty version 2.6.6, created on 2016-01-27 04:33:54
         compiled from user/update-user.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'filetemplate', 'user/update-user.html', 1, false),array('modifier', 'fileversion', 'user/update-user.html', 136, false),)), $this); ?>
            ...
            <div class="row">
              <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="user" id="user" placeholder="Digite el el usuario" value="<?php echo $this->_tpl_vars['user']['usuario']; ?>
">
                  </div>
                  <div class="form-group">
                    <label for="name">Nombre</label>
                    <input type="text" class="form-control" name="name" id="name" placeholder="Digite el nombre del usuario" value="<?php echo $this->_tpl_vars['user']['nombre']; ?>
">
                  </div>
                  <div class="form-group">
                    <label for="lastname">Apellido</label>
                    <input type="text" class="form-control" name="lastname" id="lastname" placeholder="Digite el apellido del usuario" value="<?php echo $this->_tpl_vars['user']['apellido']; ?>
">
                  </div>
                  <div class="form-group">
                    <label for="document">Documento</label>
                    <input type="text" class="form-control" name="document" id="document" placeholder="Digite el documento del usuario" value="<?php echo $this->_tpl_vars['user']['documento']; ?>
">
                  </div>
               <div class="form-group">
                    <label for="email">Correo</label>
                    <input type="email" class="form-control" name="email" id="email" placeholder="Digite el correo del usuario" value="<?php echo $this->_tpl_vars['user']['correo']; ?>
">
                  </div>
              ...
              <div class="col-md-6">
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="smartphone" id="smartphone" placeholder="Digite el celular del usuario" value="<?php echo $this->_tpl_vars['user']['celular']; ?>
">
                  </div>
                <div class="form-group">
...
?>
                      <?php if (! ( $this->_tpl_vars['user']['idRol'] === $this->_tpl_vars['role']->idRol )): ?>
                        <option value="<?php echo $this->_tpl_vars['role']->idRol; ?>
"><?php echo $this->_tpl_vars['role']->rol; ?>
</option>
                      <?php else: ?>
                        <option value="<?php echo $this->_tpl_vars['role']->idRol; ?>
" selected><?php echo $this->_tpl_vars['role']->rol; ?>
</option>
                      <?php endif; ?>
...
?>
                      <?php if (! ( $this->_tpl_vars['user']['idInstitucion'] === $this->_tpl_vars['institution']->idInstitucion )): ?>
                        <option value="<?php echo $this->_tpl_vars['institution']->idInstitucion; ?>
"><?php echo $this->_tpl_vars['institution']->institucion; ?>
</option>
                      <?php else: ?>
                        <option selected value="<?php echo $this->_tpl_vars['institution']->idInstitucion; ?>
"><?php echo $this->_tpl_vars['institution']->institucion; ?>
</option>
                      <?php endif; ?>
                    <?php endforeach; unset($_from); endif; ?>
