<?php /* Smarty version 2.6.6, created on 2016-01-25 03:18:31
         compiled from user/update-institute.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'filetemplate', 'user/update-institute.html', 1, false),array('modifier', 'fileversion', 'user/update-institute.html', 72, false),)), $this); ?>
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          ...
          <!-- form start -->
          <form role="form" id="form-institute" data-action="update">
            <div class="box-body">
